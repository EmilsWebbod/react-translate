...
import { GTranslate as GTranslateIcon } from '@material-ui/icons';
import {
  CircularProgress,
  FormControl,
  IconButton,
...
export default function Input({ value, label, googleTranslate, onChange, required, autoFocus }: Props) {
  ...
  return (
    <>
      <FormControl variant="outlined">
        <InputLabel htmlFor={label} color="secondary">
          {label}
        </InputLabel>
        <OutlinedInput
          id={label}
